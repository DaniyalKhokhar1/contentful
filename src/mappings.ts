...
export const componentMap = {
  ...
  Blog: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-blog/ctf-blog').then(
      module => module.CtfBlog,
    ),
  ),
};
...
export const componentGqlMap = {
  ...
  Blog: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-blog/ctf-blog-gql').then(
      module => module.CtfBlogGql,
    ),
  ),
};
